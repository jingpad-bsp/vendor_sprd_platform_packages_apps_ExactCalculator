...
public class UnifiedReal {
    ...
    private static final String TAG = "UnifiedReal";
    ...
    public UnifiedReal sin() {
        ...
        // UNISOC added for bug 1063615/1059906, Calculator CR library NPE problems.
        UnifiedReal crValueSin = null;
        try {
            crValueSin = new UnifiedReal(crValue().sin());
        } catch (NullPointerException e) {
            Log.d(TAG, "sin(): Calculator CR library happens NullPointerException");
            crValueSin = new UnifiedReal(CR.valueOf(0));
        }
        return crValueSin;
    }
    ...
    public UnifiedReal ln() {
        ...
        try {
            isComparable = isComparable(ZERO);
        } catch (NullPointerException e) {
            Log.d(TAG,"ln(): Calculator CR library happens NullPointerException");
        }
        if (isComparable) {
            if (signum() <= 0) {
